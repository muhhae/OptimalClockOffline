...
|-----------------------------|-----------------------|-----------------------------------|
| LR_1_spec                   |                    20 |                          14.2857  |
| LR_1_All                    |                    31 |                           5.71429 |
| LR_1_log_spec               |                    12 |                          15.7143  |
| LR_1_log_All                |                     3 |                           7.14286 |
| LR_1_mean_spec              |                    15 |                          14.2857  |
| LR_1_mean_All               |                     7 |                          10       |
...
| logistic_regression_v4_All  |                     1 |                          11.4286  |  
...
![graph](./graph/Miss_Ratio_Test_Data_Result_Obj_Size_Ignored.png)  
## Promotion Reduced (%) 
$\dfrac{Base Promotion - Model Promotion}{Base Promotion} \times 100$  

![graph](./graph/Promotion_Test_Data_Result_Obj_Size_Ignored.png)  
## True Negatives(%) 
![graph](./graph/True_Negatives_Test_Data_Result_Obj_Size_Ignored.png)  
## True Postives(%) 
![graph](./graph/True_Postives_Test_Data_Result_Obj_Size_Ignored.png)  
## False Negatives(%) 
![graph](./graph/False_Negatives_Test_Data_Result_Obj_Size_Ignored.png)  
## False Postives(%) 
![graph](./graph/False_Postives_Test_Data_Result_Obj_Size_Ignored.png)  
